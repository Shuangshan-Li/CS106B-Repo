/*  Description: The header file of HeapPQueue, descriptions for
                 student-defined member functions are in the cpp file :)
 */
...
public:
    ...
    void swapNode(int parentIndex, int childIndex);
