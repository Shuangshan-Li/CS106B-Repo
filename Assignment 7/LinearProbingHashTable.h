/*  Description: This is the header file of a hashtable implemented through linear probing
**/
#pragma once
...
private:
     ...
     */
    Slot* elems = nullptr;
    //track current number of  elements in the hashtable
    int curSize;
    //track the length of this hashtable
    int capacity;
    HashFunction<std::string> hash;
    //Intert a string at a given position
    void insertAt(int pos, const std::string& elem);
