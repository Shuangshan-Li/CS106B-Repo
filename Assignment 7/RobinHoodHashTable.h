/*  Description: This is the header file of a hashtable implemented through robinhood hashing
**/
#pragma once
...
private:
    ...
    //track the length of this hashtable
    int capacity;
    //track the number of elements currently in this hashtable
    int curSize;
    //return the index of an element in this hashtable
    int find(const std::string& elem) const;
    //inset a string at a certain position
    void insertAt(int pos, int distance, const std::string& elem);
